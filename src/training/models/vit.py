...
from src.training.models.vit_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from src.training.models.helpers import load_pretrained
from src.training.models.vit_utils import DropPath, to_2tuple, trunc_normal_
...
model = TimeSformer(img_size=224, patch_size=16, num_classes=2, num_frames=16, attention_type='divided_space_time', pretrained_model='')

test_video = torch.randn(1, 16, 3, 224, 224)

print(model(test_video).shape)